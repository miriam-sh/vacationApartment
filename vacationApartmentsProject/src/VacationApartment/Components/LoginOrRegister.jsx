...
export const LoginOrRegister = () => {
    ...
    const openMailPopup = () => {
        const width = 600
        const height = 400
        window.open('https://mail.google.com/mail/?view=cm&fs=1&to=vacationApartmentDM@gmail.com', 'mymailpopup', `width=${width},height=${height},left=${(window.innerWidth - width) / 2},top=${(window.innerHeight - height) / 2}`);
    };
            ...
            <div className="loginOrRegister">
                ...
                <div className="accordions" >
                    ...
                    <Accordion style={{ borderRadius: "15px", position: "static" }}>
                        ...
                        <AccordionDetails>
                            אין בעיה! אנחנו זמינים כאן בשבילך באימייל
                            <a id="emailLink" href="#" onClick={(e) => { e.preventDefault(); openMailPopup(); }}>
                                vacationApartmentDM@gmail.com
                            </a>
                        </AccordionDetails>
                    </Accordion>
                </div>
