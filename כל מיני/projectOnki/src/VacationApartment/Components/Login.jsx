        ...
        <>
            <div className="login">
                <form className="form" onSubmit={(e) => send(e)}>
                    ...
                    <NavLink id="verifyEmailButton" to={`verifyEmail/${document.getElementById("advisterEmail") && document.getElementById("advisterEmail").value!="" ? document.getElementById("advisterEmail").value : "null"}`}>שכחתי סיסמא</NavLink>
