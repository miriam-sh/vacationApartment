...
import { getById, getAll, getByAdvertiser, getByCategory, getByCity, create, update,remove, getByCountOfBedsSmaller, getByCountOfBedsBigger, getByCountOfBedsEqual, getByPriceSmaller, getByPriceBigger, getByPriceEqual } from '../controllers/apartment.js';
...
router.put('/:id',checkAuth,allowedCange, update);
