...
export const Apartments = () => {
    ...
    return (<>
        ...
        <div className="filters">
            ...
            {filterBy == 1 && <ToFilter filter={-1} list={cities} setApartments={filterByCity} getAllApartments={getAllApartments}></ToFilter>}
            {filterBy == 2 && <ToFilter filter={-1} list={categories} setApartments={filterByCategory} getAllApartments={getAllApartments}></ToFilter>}
        </div>
        <br />
        <div id="cards">
